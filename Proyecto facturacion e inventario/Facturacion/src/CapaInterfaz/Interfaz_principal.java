...
control_existencias ctrl;
     ...
     */
    public Interfaz_principal() throws SQLException {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
       Interfaz_buscarclientes buscar = null;
    try {
        buscar = new Interfaz_buscarclientes();
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        Interfaz_articulo art = null;
    try {
        art = new Interfaz_articulo();
    } catch (SQLException ex) {
        Logger.getLogger(Interfaz_principal.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
          ...
          Interfaz_Clientes cli = null;       
    try {
        cli = new Interfaz_Clientes();
    } catch (SQLException ex) {
        Logger.getLogger(Interfaz_principal.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void BuscararticulosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscararticulosActionPerformed
        interfaz_buscararticulos bus = null;
    try {
        bus = new interfaz_buscararticulos();
    } catch (SQLException ex) {
        Logger.getLogger(Interfaz_principal.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    interfaz_consultas consulta = null;
    try {
        consulta = new interfaz_consultas();
    } catch (SQLException ex) {
        Logger.getLogger(Interfaz_principal.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    Interfaz_devoluciones dev = null;
    try {
        dev = new Interfaz_devoluciones();
    } catch (SQLException ex) {
        Logger.getLogger(Interfaz_principal.class.getName()).log(Level.SEVERE, null, ex);
    }
