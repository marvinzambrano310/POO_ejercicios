...
import CapaNegocio.control_existencias;
import CapaNegocio.control_cliente;
...
public final class Interfaz_Clientes extends javax.swing.JInternalFrame {
    ...
    public Interfaz_Clientes() throws SQLException {
        this.ctrl = new control_existencias();
        initComponents();    
        limpiar();
        bloquear_cajas();
    ...
    private void regclientejButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regclientejButton1ActionPerformed
        ...
        control_cliente contr = null;
        try {
            contr = new control_cliente(doc, tipo, nom, ape, dir, ciu,tel);
        } catch (SQLException ex) {
            Logger.getLogger(Interfaz_Clientes.class.getName()).log(Level.SEVERE, null, ex);
        }
