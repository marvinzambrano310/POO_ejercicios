...
import CapaNegocio.control_articulos;
...
control_existencias con;
     ...
     */
    public Interfaz_articulo() throws SQLException {
        this.con = new control_existencias();
        initComponents();
        limpiar();
        bloquear_cajas();
...
public void limpiar()
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        control_articulos ctrl = null;
    try {
        ctrl = new control_articulos();
    } catch (SQLException ex) {
        Logger.getLogger(Interfaz_articulo.class.getName()).log(Level.SEVERE, null, ex);
    }
        if(!des.equals(""))
         {          
        if(ctrl.ingresar_articulo(null,des,preve,precos,sto,tipo,prov))
         {            
