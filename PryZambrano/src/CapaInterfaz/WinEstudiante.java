...
public class WinEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BtnInsertar.setFont(new java.awt.Font("Tempus Sans ITC", 3, 14)); // NOI18N
    ...
    private void ItmMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ItmMateriaActionPerformed
        ...
        try {
            datos=new ClsBdEstudiante(bd);
            datos.Consulta("TbEstudiante");
        } catch (SQLException ex) {
            Logger.getLogger(WinEstudiante.class.getName()).log(Level.SEVERE, null, ex);
        }
        CmbNombreEst.removeAllItems();
        try {
            for (int i=0;r.next();i++){
                datos.siguiente();
                CmbNombreEst.addItem(datos.getRegistro().getString("Nombre"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(WinEstudiante.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void BtnSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSiguienteActionPerformed
       try {
            datos.siguiente();
            TxtClave.setText(datos.getRegistro().getString("Clave"));
            TxtNombre.setText(datos.getRegistro().getString("Nombre"));
            TxtDireccion.setText(datos.getRegistro().getString("Direccion"));
            TxtSexo.setText(datos.getRegistro().getString("Sexo"));   
            int clv=datos.getRegistro().getInt("Clave");
            notas=new ClsBdEstudiante(bd);
            notas.Consulta1(clv);
            CmbNotas.removeAllItems();
            for (int i=0;r.next();i++){
                notas.siguiente();
                CmbNotas.addItem(notas.getRegistro().getString("Nota")+"/10");
            }
            } catch (SQLException ex) {
            Logger.getLogger(WinEstudiante.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void BtnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInsertarActionPerformed
        ...
        try{
            datos.insertarE("TbEstudiante", nombre, direccion, sexo);
